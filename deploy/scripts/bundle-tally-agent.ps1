...
try {
    ...
    foreach ($file in @('agent.js','tally.js','source-agent.js','source-export.js','tally-source-parser.js','export-diagnostics.js','outbox.js','launcher.js','startup.js','login-windows.ps1','Run-Sync.cmd','run-sync.ps1','package.json','package-lock.json')) {
    ...
    foreach ($file in @('agent.js','tally.js','source-agent.js','source-export.js','tally-source-parser.js','export-diagnostics.js','outbox.js','launcher.js','startup.js')) {
